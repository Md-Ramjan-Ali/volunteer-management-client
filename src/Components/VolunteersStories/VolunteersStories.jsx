...
const VolunteersStories = () => {
  return (
    <section className=" my-20 px-4 max-w-7xl mx-auto">
      <h2 className="text-3xl font-bold text-center mb-8">Volunteer Stories</h2>
